...
execute if block ~ ~ ~ #minecraft:slabs[type=top] run function thewii:vp_library/raycasting/mrcd/cube/main
...
scoreboard players set #box_z1 twvp.temp 1000
execute if block ~ ~ ~ #minecraft:slabs[type=bottom] run function thewii:vp_library/raycasting/mrcd/cube/main
...
scoreboard players set #box_y1 twvp.temp 1000
scoreboard players set #box_z1 twvp.temp 1000
execute if block ~ ~ ~ #minecraft:slabs[type=double] run function thewii:vp_library/raycasting/mrcd/cube/main
