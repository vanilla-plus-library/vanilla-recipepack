...
execute if score #recipe vplib.temp matches 0 if score #ingredient_5 vplib.temp matches 1.. store result score #ingredient_6 vplib.temp run data get storage vplib:temp recipeInput[{Slot:20b,id:"minecraft:obsidian"}].Count
execute if score #recipe vplib.temp matches 0 if score #ingredient_6 vplib.temp matches 1.. store result score #ingredient_7 vplib.temp run data get storage vplib:temp recipeInput[{Slot:21b,id:"minecraft:obsidian"}].Count
execute if score #recipe vplib.temp matches 0 if score #ingredient_7 vplib.temp matches 1.. store result score #ingredient_8 vplib.temp run data get storage vplib:temp recipeInput[{Slot:22b,id:"minecraft:obsidian"}].Count
