...
# Register
execute unless score #vanilla.shield vplib.recipe matches 1.. store result score #vanilla.shield vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:11b,id:"minecraft:book"},{Slot:12b,id:"minecraft:book"},{Slot:13b,id:"minecraft:book"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.shield vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.shield vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:shield",Count:1b,tag:{Damage:0}}