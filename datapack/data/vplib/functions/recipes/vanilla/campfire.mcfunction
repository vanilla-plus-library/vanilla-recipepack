...
# Register
execute unless score #vanilla.campfire vplib.recipe matches 1.. store result score #vanilla.campfire vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:3b,id:"minecraft:stick"},{Slot:11b,id:"minecraft:stick"},{Slot:13b,id:"minecraft:stick"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.campfire vplib.recipe


# Output
execute if score #recipe vplib.temp = #vanilla.campfire vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:campfire",Count:1b}