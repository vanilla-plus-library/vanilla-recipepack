...
# Register
execute unless score #vanilla.furnace vplib.recipe matches 1.. store result score #vanilla.furnace vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 run scoreboard players operation #recipe vplib.temp = #vanilla.furnace vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.furnace vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:furnace",Count:1b}