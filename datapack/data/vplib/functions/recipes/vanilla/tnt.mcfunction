...
# Register
execute unless score #vanilla.tnt vplib.recipe matches 1.. store result score #vanilla.tnt vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 run function vplib:recipes/vanilla/item_tags/sands
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:2b,id:"minecraft:gunpowder"},{Slot:4b,id:"minecraft:gunpowder"},{Slot:12b,id:"minecraft:gunpowder"},{Slot:20b,id:"minecraft:gunpowder"},{Slot:22b,id:"minecraft:gunpowder"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.tnt vplib.recipe


# Output
execute if score #recipe vplib.temp = #vanilla.tnt vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:tnt",Count:1b}