...
# Register
execute unless score #vanilla.smithing_table vplib.recipe matches 1.. store result score #vanilla.smithing_table vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:2b,id:"minecraft:iron_ingot"},{Slot:3b,id:"minecraft:iron_ingot"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.smithing_table vplib.recipe
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:3b,id:"minecraft:iron_ingot"},{Slot:4b,id:"minecraft:iron_ingot"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.smithing_table vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.smithing_table vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:smithing_table",Count:1b}