...
# Register
execute unless score #vanilla.red_sandstone_slab vplib.recipe matches 1.. store result score #vanilla.red_sandstone_slab vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 run scoreboard players operation #recipe vplib.temp = #vanilla.red_sandstone_slab vplib.recipe
...
# Output
execute if score #recipe vplib.temp = #vanilla.red_sandstone_slab vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:red_sandstone_slab",Count:6b}