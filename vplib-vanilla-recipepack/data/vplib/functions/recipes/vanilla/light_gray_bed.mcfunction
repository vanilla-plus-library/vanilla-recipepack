...
# Register
execute unless score #vanilla.light_gray_bed vplib.recipe matches 1.. store result score #vanilla.light_gray_bed vplib.recipe run scoreboard players add $register vplib.recipe 1
...
# Output
execute if score #recipe vplib.temp = #vanilla.light_gray_bed vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:light_gray_bed",Count:1b}