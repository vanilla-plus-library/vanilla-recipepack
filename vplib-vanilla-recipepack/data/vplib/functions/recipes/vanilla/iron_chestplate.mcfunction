...
# Register
execute unless score #vanilla.iron_chestplate vplib.recipe matches 1.. store result score #vanilla.iron_chestplate vplib.recipe run scoreboard players add $register vplib.recipe 1
