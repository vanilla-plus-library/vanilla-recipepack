...
# Register
execute unless score #vanilla.crafting_table vplib.recipe matches 1.. store result score #vanilla.crafting_table vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 run scoreboard players operation #recipe vplib.temp = #vanilla.crafting_table vplib.recipe
...
# Output
execute if score #recipe vplib.temp = #vanilla.crafting_table vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:crafting_table",Count:1b}