...
# Output
execute if score #recipe vplib.temp = #vanilla.diamond_chestplate vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:diamond_chesplate",Count:1b,tag:{Damage:0}}