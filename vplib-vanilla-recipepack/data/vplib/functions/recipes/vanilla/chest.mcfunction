...
# Register
execute unless score #vanilla.chest vplib.recipe matches 1.. store result score #vanilla.chest vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 run scoreboard players operation #recipe vplib.temp = #vanilla.chest vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.chest vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:chest",Count:1b}