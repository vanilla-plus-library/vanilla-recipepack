...
# Output
execute if score #recipe vplib.temp = #vanilla.leather_chestplate vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:leather_chesplate",Count:1b,tag:{Damage:0}}