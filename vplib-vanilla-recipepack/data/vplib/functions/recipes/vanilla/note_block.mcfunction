...
# Register
execute unless score #vanilla.note_block vplib.recipe matches 1.. store result score #vanilla.note_block vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:12b,id:"minecraft:redstone"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.note_block vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.note_block vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:note_block",Count:1b}