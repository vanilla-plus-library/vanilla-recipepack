...
# Register
execute unless score #vanilla.jukebox vplib.recipe matches 1.. store result score #vanilla.jukebox vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:12b,id:"minecraft:diamond"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.jukebox vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.jukebox vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:jukebox",Count:1b}