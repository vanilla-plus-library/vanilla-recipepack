...
# Register
execute unless score #vanilla.composter vplib.recipe matches 1.. store result score #vanilla.composter vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 run function vplib:recipes/vanilla/item_tags/wooden_slabs
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 run scoreboard players operation #recipe vplib.temp = #vanilla.composter vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.composter vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:composter",Count:1b}