...
# Register
execute unless score #vanilla.cartography_table vplib.recipe matches 1.. store result score #vanilla.cartography_table vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:2b,id:"minecraft:paper"},{Slot:3b,id:"minecraft:paper"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.cartography_table vplib.recipe
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:3b,id:"minecraft:paper"},{Slot:4b,id:"minecraft:paper"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.cartography_table vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.cartography_table vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:cartography_table",Count:1b}