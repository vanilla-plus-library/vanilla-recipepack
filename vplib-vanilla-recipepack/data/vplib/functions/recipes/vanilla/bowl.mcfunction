...
# Register
execute unless score #vanilla.bowl vplib.recipe matches 1.. store result score #vanilla.bowl vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 run scoreboard players operation #recipe vplib.temp = #vanilla.bowl vplib.recipe
...
# Output
execute if score #recipe vplib.temp = #vanilla.bowl vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:bowl",Count:4b}