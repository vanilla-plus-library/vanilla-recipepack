...
# Output
execute if score #recipe vplib.temp = #vanilla.golden_chestplate vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:golden_chesplate",Count:1b,tag:{Damage:0}}