...
# Register
execute unless score #vanilla.brewing_stand vplib.recipe matches 1.. store result score #vanilla.brewing_stand vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:3b,id:"minecraft:blaze_rod"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.brewing_stand vplib.recipe
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:12b,id:"minecraft:blaze_rod"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.brewing_stand vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.brewing_stand vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:brewing_stand",Count:1b}