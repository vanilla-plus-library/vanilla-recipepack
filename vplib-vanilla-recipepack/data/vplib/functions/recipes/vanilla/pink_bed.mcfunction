...
# Register
execute unless score #vanilla.pink_bed vplib.recipe matches 1.. store result score #vanilla.pink_bed vplib.recipe run scoreboard players add $register vplib.recipe 1
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:2b,id:"minecraft:pink_wool"},{Slot:3b,id:"minecraft:pink_wool"},{Slot:4b,id:"minecraft:pink_wool"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.pink_bed vplib.recipe
...
execute if score #recipe vplib.temp matches 0 if score #matched vplib.temp matches 1 if data storage vplib:temp {recipeInput:[{Slot:11b,id:"minecraft:pink_wool"},{Slot:12b,id:"minecraft:pink_wool"},{Slot:13b,id:"minecraft:pink_wool"}]} run scoreboard players operation #recipe vplib.temp = #vanilla.pink_bed vplib.recipe

# Output
execute if score #recipe vplib.temp = #vanilla.pink_bed vplib.recipe run data modify storage vplib:temp recipeOutput set value {id:"minecraft:pink_bed",Count:1b}