...
# Displace X
function vp_library:generation/ore_gen/displace_x

# Loop until #veins = 0
scoreboard players remove #veins vp_temp 1
execute if score #veins vp_temp matches 1.. run function vp_library:generation/ore_gen/generate_veins_loop
