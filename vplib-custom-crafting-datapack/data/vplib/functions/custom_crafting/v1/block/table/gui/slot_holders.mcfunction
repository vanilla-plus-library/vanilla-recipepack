...
data modify storage vplib:temp json set value ['[{"translate":"space.-8","font":"space:default","color":"white"},{"text":"\\ue001","font":"vplib:custom_crafting/v1/gui"},{"translate":"space.-172","font":"space:default"}]']
